 ...
 * @author axell
 */
public class BoiteSupprimer extends JDialog implements ActionListener {

    //attribut graphique
    private JButton btAnnuler, btSupprimer, btLeft, btRight;
    ...
    public BoiteSupprimer(Fenetre owner) {
        ...
        this.setIconImage(new ImageIcon(this.getClass().getResource("deleteicon.png")).getImage());

        this.x = 0;
        this.listPizza=owner.getListPizza();
        this.btSupprimer = new JButton("Supprimer");
        btSupprimer.setBackground(Color.GREEN);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == btSupprimer) {
            this.listPizza.remove(x);
            this.setVisible(false);//on ferme la fenêtre
    ...
    public ArrayList<Pizza> showDialog() {
        this.setVisible(true);//on ouvre la fenêtre
        return listPizza;//on retourne Le résultat
    }
